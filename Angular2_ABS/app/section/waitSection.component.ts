...
@Component({
	...
	templateUrl: './waitSection.component.html',
	styleUrls: ['./waitSection.component.css']
	//animations: [
	//	trigger('alertToggle', [
	//		state('true', style({
	//			opacity: 1
...
export class WaitSectionComponent implements OnInit {
	...
	subStart() {
		this.ios.getPageMove().subscribe(msg => {
