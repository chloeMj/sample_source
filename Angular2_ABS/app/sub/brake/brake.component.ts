...
export class BrakeComponent implements OnInit {
	...
	constructor(
		...
		// this.weightValue.mean = 2100;
		// this.leftValue.mean = 1792;
		// this.leftValue.subValue = 2154;
		// this.leftValue.release =  2154;
		// this.rightValue.mean = 1772;
		// this.rightValue.subValue = 2074;
		// this.rightValue.release =  2074;
