			...
			root:{
				...
				children: [{
				   ...
				   // icon:'/led-icons/folder.gif',
					...
					//  url: '/pages/menu/config/custom/UserMetadataPanel.js',
						leaf: true
					},{
						//>>text: '시스템 메타데이터',
				...
				,{
					...
					children: [{
						...
						//>>text: 'Context Menu Workflow',//바로가기 메뉴 설정
					...
					*/
					...
					children: [{
						...
						id:'agent_monitor',
						//text: '에이전트 모니터링',
						text: '<span style="position:relative;top:3px;"><i class="fa fa-angle-right" style="font-size:18px;"></i></span>&nbsp;<?=_text('MN02144')?>',
						title: '<?=_text('MN02144')?>',
						icon:'/led-icons/folder.gif',
				...
				,{
					...
					?>
					//icon:'/led-icons/folder.gif',
					url: '/pages/menu/harris/harris_mn_list.php',
					leaf: true
				},{
					//text: '보도정보',
